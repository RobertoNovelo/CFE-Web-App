...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	*/
		h3{
			/*@editable*/color:#51d682 !important;
			/*@editable*/font-family:Helvetica;
	...
	*/
		h4{
			/*@editable*/color:#4ac954 !important;
			/*@editable*/font-family:Helvetica;
	...
	*/
		.headerFrontBackground,.headerRearBackground{
			/*@editable*/background-color:#52b86f;
		}
	/*
	@tab Header
	@section header container
	...
	*/
		.headerFrontBackground{
			/*@editable*/border-bottom:2px solid #838383;
		}
	/*
	@tab Header
	@section header text
...
@tip Make the template fluid for portrait or landscape view adaptability. If a fluid layout doesn't work for you, set the width to 300px instead.*/max-width:600px !important;
	...
	*/
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/9b185374cc25b70fed5922fac/images/4225662a-da43-4782-b00d-4e83f1c7239c.jpg" width="286" style="max-width:286px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1 style="text-align: center;">Actualización de Estado</h1>
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="padding: 18px;">
                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-top-width: 1px;border-top-style: solid;border-top-color: #E2D8D8;">
                    <tbody><tr>
                        <td>
                            <span></span>
                        </td>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <div style="text-align: center;"><?php echo $comment;?><br>
<br>
Esta actualizacion fue realizada el <?php echo $date;?> a las <?php echo $time; ?></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <em>Derechos Reservados © 2014 CFE</em>
                        </td>
                    </tr>
                </tbody></table>
